...
class KLogger
{
     ...
     * @return void
     */
    public function __construct($logDirectory=false,$severity=7)
    {
       
        if($logDirectory)
        $logDirectory = rtrim($logDirectory, '\\/');
        else $logDirectory = $this->create_dir(PRIVATE_LOG);
     ...
     * @return void
     */
    public function logInfo($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::INFO, $mail, $args);
    }
     ...
     * @return void
     */
    public function logNotice($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::NOTICE, $mail, $args);
    }
     ...
     * @return void
     */
    public function logWarn($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::WARN, $mail, $args);
    }
     ...
     * @return void
     */
    public function logError($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::ERR, $mail, $args);
    }
     ...
     */
    public function logFatal($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::FATAL, $mail, $args);
    }
     ...
     * @return void
     */
    public function logAlert($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::ALERT, $mail, $args);
    }
     ...
     * @return void
     */
    public function logCrit($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::CRIT,  $mail, $args);
    }
     ...
     * @return void
     */
    public function logEmerg($line, $mail=false, $args = self::NO_ARGUMENTS)
    {
        $this->log($line, self::EMERG, $mail, $args);
     ...
     */
    public function log($line, $severity,$mail, $args = self::NO_ARGUMENTS)
    {
            ...
            if($mail){
                ...
                $sent = $email->send(MAIL_FROMNAME, $mail, 'ALERT: '.$severity, $line);

                if(!$sent)
                $this->logAlert("Mail was not sent: ".$line);
            }
